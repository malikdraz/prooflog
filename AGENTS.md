...
- `prooflog proof --since <REF>` currently detects repo root, branch, HEAD, merge base, dirty status, changed files, diff stats, and docs-only status. Final proof report generation is still planned.
