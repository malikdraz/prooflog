...
- `prooflog proof --since <REF>` currently emits plain text, Markdown, and experimental JSON reports with scope, changed files, Codex evidence, parser warning counts, verification, failures, risks, a conservative READY/NOT READY/UNKNOWN decision, why/next-step data, and decision-based exit codes.
