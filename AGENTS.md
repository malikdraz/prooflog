...
- `prooflog init` currently creates local TOML config and initializes the SQLite schema.
- `prooflog doctor` currently reads config and prints storage status; full readiness checks are separate follow-up work.
